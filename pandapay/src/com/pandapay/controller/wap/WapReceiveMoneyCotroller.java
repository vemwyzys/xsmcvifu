 ...
 */
@Controller
@RequestMapping("/userWap/wapReceiveMoney")
@Scope(value="prototype")
public class WapReceiveMoneyCotroller {
	...
	/** 提交收款信息，打开支付二维码 */
	@RequestMapping(value = "/receive.htm")
	public String receive(HttpServletRequest request){
    	...
    	JsonObjectBO userOrderPay = userOrderPayService.addPayOrder(userSessionBO.getUserId(), payAmount, payWay);
