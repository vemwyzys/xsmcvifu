 ...
 *
 */
@Service("backerRecordWalletAmountService")
public class BackerRecordWalletAmountServiceImpl implements IBackerRecordWalletAmountService {
	
	/**用户钱包账户操作记录*/
	@Autowired
	private IBackerRecordWalletAmountDao backerRecordWalletAmountDao;
	...
	public boolean insertRecord(BackerRecordWalletAmountDO backerRecordWalletAmount){
		return backerRecordWalletAmountDao.insertRecord(backerRecordWalletAmount);
	}
	...
	public int queryRecordTotalOfBack(String userAccount, int handleType, String remarks, String backerAccount, Timestamp startTime, Timestamp endTime){
		return backerRecordWalletAmountDao.queryRecordTotalOfBack(userAccount, handleType, remarks, backerAccount, startTime, endTime);
	}
	...
	public List<BackerRecordWalletAmountDO> queryRecordListOfBack(String userAccount, int handleType, String remarks, String backerAccount,
		...
		return backerRecordWalletAmountDao.queryRecordListOfBack(userAccount, handleType, remarks, backerAccount,
